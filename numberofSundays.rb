...
$day = [:sunday, :monday, :tuesday, :wednseday, :thursday, :friday, :saturday]
	...
	def getNumberOfFirsts
		#0 will be Sunday, 1 will be Monday etc.
		currentMonth = 1
		currentYear = 1900
		numberOfSundays = 0
		dateOfFirst = 1 # 01/01/1901 is a Monday, this is established. therefor 12/31/
		...
		for i in currentYear..2000
			for j in currentMonth..12
				...
				if dateOfFirst == 0 and i >= 1901 #need to calculate dates from 1900 but don't want to start calculating the number of Sundays til 1901
